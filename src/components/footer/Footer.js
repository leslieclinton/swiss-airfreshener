        ...
        <div className="footer">
            <div className="footer_main">
                ...
                <div className="footer__links">
                    <div className="footer__links-quick">
                        ...
                        <ul>
                            ...
                            <li><Link to='/distributor'>Distributorship</Link></li>
                    ...
                    <div className="footer__links-products">
                        ...
                        <ul>
                            ...
                            <li><Link to='/card'>Dangler</Link></li>
                ...
                <div className="footer__social">
                    <span>
                        <a href="https://www.instagram.com/realswissflower/" target="_blank"  rel="noreferrer" >
                    ...
                    <span>
                        <a href='https://www.facebook.com/realswissflower' target="_blank"  rel="noreferrer" > 
                    ...
                    <span>
                        <a href='https://www.twitter.com/realswissflower' target="_blank"  rel="noreferrer">
